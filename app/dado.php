...
#dadowrapper {  width: 200px;  height: 200px;  position: relative;margin:50px auto;   -webkit-perspective: 1500px;perspective: 1500px;}
#scene { width:100%; height:100%; -webkit-transform-style: preserve-3d;-moz-transform-style: preserve-3d;transform-style: preserve-3d; -webkit-transform: rotateX( -50deg ) translateZ( 30px ) rotateY( 30deg ) ; transform: rotateX( -50deg ) translateZ( 30px ) rotateY( 30deg ) ;}
#dado {display:block; width:100%; height:100%; -webkit-transform-style: preserve-3d;-moz-transform-style: preserve-3d;transform-style: preserve-3d; position: absolute; top:0px; left:0px;  padding:0; margin:0; list-style: none; transition:2s ease-out}
...
#dado li div {position: absolute; top:0px; left:0px; width:100%; height:100%; background:#bbb;border-radius:10px;-webkit-transform: translateZ( -10px );}
