...
function colorcielo() {
	if(hours<24) $('#pageapp').css('background-color','#191970');
//	if(hours<22) $('#pageapp').css('background-color','#C71585');
	if(hours<18) $('#pageapp').css('background-color','#1E90FF');
	if(hours<12) $('#pageapp').css('background-color','#87CEFA');
	if(hours<8) $('#pageapp').css('background-color','#111122');
}
function f5reloj() {
